...
bucket_name = "soccer-analytics-data-lake-ham004"  # Change to a unique S3 bucket name
glue_database_name = "glue_nba_data_lake-ham004"
    ...
    try:
        glue_client.create_database(
            DatabaseInput={
                ...
                "Description": "Glue database for SOCCER sports analytics.",
            }
        )
...
def fetch_nba_data():
    """Fetch SOCCER standing data from sportsdata.io."""
    try:
...
def upload_data_to_s3(data):
    ...
    try:
        ...
        file_key = "raw-data/soccer_standing_data.json"
...
def create_glue_table():
    ...
    try:
        glue_client.create_table(
            ...
            TableInput={
                "Name": "soccer_stadings",
                "StorageDescriptor": {
                    "Columns": [
                        {"Name": "StandingId", "Type": "int"},
        ...
        print(f"Glue table 'soccer_stadings' created successfully.")
    except Exception as e:
...
def configure_athena():
    ...
    try:
        athena_client.start_query_execution(
            QueryString="CREATE DATABASE IF NOT EXISTS soccer_analytics",
...
# Main workflow
def main():
    print("Setting up data lake for SOCCER sports analytics...")
    create_s3_bucket()
